...
public class StartUpApp implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		if (userService.findAll().isEmpty()) {
			...
			userService.save(new AppUser(null, "Tabat", "tabat", "123", adminRoles, true, true, true, true));
			
			userService.save(new AppUser(null, "alex", "alex", "123", userRoles, true, true, true, true));
			
			userService.save(new AppUser(null, "abdelfettah", "abdel", "123", empRoles, true, true, true, true));
		}
